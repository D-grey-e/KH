...
public class OpExample2 {
	...
	public static void main(String[] args) {
		...
		System.out.printf("7은 짝수입니까? %b \n", 7 % 2 != 1);
		
		System.out.println("[홀수 검사]");
		// 홀수 == 2로 나누었을 때 나머지가 1인 수
		//	   == 2로 나누었을 때 나머지가 0이 아닌 수
		
		System.out.printf("12345는 홀수 입니까? %b \n", 12345 % 2 == 1);
		System.out.printf("5432는 홀수 입니까? %b \n", 5432 % 2 != 0 );
		System.out.printf("12345는 홀수 입니까? %b \n", 12345 % 2 == 1);
		
		System.out.println("---------------------------------------");
		
		System.out.println("[3의 배수 검사]");
		// 3의 배수 == 3으로 나눴을 때 나머지가 0인수
		
		System.out.printf("123123은 3의 배수 입니까? %b \n", 123123 % 3 == 0);
