...
public class OpExample4 {
	...
	public static void main(String[] args) {
		...
		System.out.println("104 는 50 이상이면서 짝수인가? " + result1);
		
		System.out.println("----------------------------------------");
		
		// num2 는 50 이하이고, 2의 배수인가?
		int num2 = 70;
		boolean result2 = num2 <= 50 && 70 % 2 == 0;
		System.out.println( num2 + "는 50 이하이고 2의 배수인가? " + result2);
	
		// num3는 1부터 100사이의 정수 인가?
		int num3 = 65;
		boolean result3 = num3 >= 1 && num3 <= 100;
		System.out.println(num3 + "는 1부터 100사이의 정수 인가? " + result3);
		
		System.out.println("----------------------------------------");
		
		/* OR 연산자 (||) : 둘 다 false 이면 fales, 아니면 true
		 * - 또는, ~이거나(거나)
		 * */
		...
		System.out.println("num4는 10을 초과 하거나 홀수인가? " + result4);
		...
		System.out.println("num6는 짝수 입니까? " + result6);
		System.out.println("num6는 홀수 입니까? " + !result6);
